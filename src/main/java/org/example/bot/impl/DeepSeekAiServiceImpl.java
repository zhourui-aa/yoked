...
public class DeepSeekAiServiceImpl implements AiService {
    ...
    public DeepSeekAiServiceImpl(DatabaseManager dbManager, String defaultPersona, String techInstructions) {
        ...
        this.client = OpenAIOkHttpClient.builder()
                ...
                .baseUrl(BASE_URL)
                .build();
        this.sessionManager = new SessionManager(dbManager,defaultPersona, techInstructions);
    ...
    public String chat(String userId, String userMessage) {
        ...
        try {
            ...
            if (reply.isBlank()) {
                System.out.println("[AI] ⚠ API 返回空白内容");
                reply = "嗯？我好像没听清，能再说一遍吗？";
            }
        ...
        try {
            ...
            for (int round = 0; round < MAX_FC_ROUNDS; round++) {
                ...
                if (toolCalls.isEmpty()) {
                    ...
                    System.out.println("[AI] ⚠ FC 第一轮返回空白，降级到自由对话");
